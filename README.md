...
| _02Codes_   |  `0_HS_to_ITPD_mapping.do` maps HS codes to ITPD sectors; `01_HS_to_ISIC_concordance` converts HS codes to ISIC codes;  `1_Data_Preparation` prepares .txt and .csv files to produce clean datasets: trade_byitpd.dta, grav_vars.dta, and tariff_hs6.dta   |
| _03Documentation_   | contains reference papers, complete guide that describes the data and methodology  |
| _04Misc   | ... |
